...
import org.prime.easykarobar.ui.shared.reportsShared.getMonthRange
        ...
        TallyReportScaffold(
            ...
            onExcelClick = {
                scope.launch {
                    ...
                    handlePdfAction(
                        fileName = "SalesmanGroupWiseTargetReport",
                        htmlContent = htmlContent,
                        headers = listOf(
                            "Salesman Name", "Group Name", "Target Qty", "Achieved Qty", "Balance Qty",
